...
<section class="legal-section alt">
  ...
  <div class="legal-grid">
    ...
    <article class="legal-card"><span class="badge">Responsabilidad</span><h3>Deber de seguridad</h3><p>El art. 75 de la LCT obliga a proteger la integridad y la dignidad de tus equipos. No prevenir la violencia laboral genera responsabilidad y litigios en aumento.</p><p class="legal-ref">LCT, art. 75 · Convenio 190 OIT</p></article>
    <article class="legal-card"><span class="badge accent">Sector público</span><h3>Ley Micaela</h3><p>Capacitación en género obligatoria en el Estado — y el estándar que cada vez más empresas privadas adoptan para no quedarse atrás.</p><p class="legal-ref">Ley 27.499 (2018)</p></article>
  </div>
</section>
