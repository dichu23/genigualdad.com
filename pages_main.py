...
<section class="legal-section alt">
  ...
  <div class="legal-grid">
    ...
    <article class="legal-card"><span class="badge">Responsabilidad</span><h3>Deber de seguridad</h3><p>El artículo 75 de la Ley de Contrato de Trabajo obliga al empleador a adoptar todas las medidas necesarias para proteger la integridad psicofísica y la dignidad de las personas trabajadoras, lo que comprende la prevención y el abordaje de la violencia y el acoso en el ámbito laboral. Su incumplimiento genera responsabilidad y una litigiosidad creciente.</p><p class="legal-ref">LCT, art. 75</p></article>
    <article class="legal-card"><span class="badge accent">Sector público</span><h3>Ley Micaela</h3><p>Establece la capacitación obligatoria en género y violencia contra las mujeres para todas las personas que se desempeñan en la función pública, en los poderes Ejecutivo, Legislativo y Judicial de la Nación. Si bien no obliga al sector privado, es una referencia de estándar que un número creciente de empresas adopta de forma voluntaria.</p><p class="legal-ref">Ley 27.499 (2018)</p></article>
  </div>
</section>
