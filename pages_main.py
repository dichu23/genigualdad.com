...
<section class="timeline-section" id="trayectoria">
  <div class="section-title"><p class="eyebrow">Trayectoria en acción</p><h2>Veinticinco años construyendo método</h2></div>
  <div class="timeline">
...
<section class="services-lite">
  <div class="section-title"><p class="eyebrow">Cómo lo resolvemos</p><h2>Del diagnóstico al registro, sin fricción</h2></div>
  <div class="process-grid light">
    <article><span class="process-num">01</span><h3>Diagnóstico</h3><p>Relevamos la situación de tu empresa: plantilla, retribuciones, procedimientos y cultura.</p></article>
    <article><span class="process-num">02</span><h3>Diseño y negociación</h3><p>Elaboramos el plan, el protocolo y el registro con la participación que exige la norma.</p></article>
    <article><span class="process-num">03</span><h3>Registro e implantación</h3><p>Acompañamos el registro oficial y la puesta en marcha de las medidas.</p></article>
    <article><span class="process-num">04</span><h3>Formación y seguimiento</h3><p>Formamos a plantilla, mandos y RR.HH., y medimos el avance con indicadores.</p></article>
  </div>
  <div class="service-links">
    <a href="/servicios/protocolos-de-igualdad">Protocolos de igualdad {IC["arrow"]}</a>
    <a href="/servicios/diagnosticos-y-planes">Planes de igualdad y diagnósticos {IC["arrow"]}</a>
    <a href="/servicios/capacitaciones">Formación para plantilla y RR.HH. {IC["arrow"]}</a>
    <a href="/servicios/asesoria-juridica">Asesoría jurídica {IC["arrow"]}</a>
  </div>
</section>
...
<section class="galicia">
  <div class="galicia-inner">
    <div>
      ...
      <p>Nuestro director de asuntos jurídicos, formado en la Universidad de Santiago de Compostela, lidera la operación en España. Trabajamos de forma presencial en Galicia y virtual o híbrida en el resto del territorio, en castellano y en galego.</p>
